...
# -------------------   neutron_addStaticRoute    -------------------------------------------

def neutron_addStaticRoute(token_id,router_id,routes_destination,routes_nexthop,controller_ip,service_port):

    # Parameter Testing : Do parameter check before sending request
    logging.warning('start neutron_addStaticRoute')
    
    # official api
    auth_url = "http://"+controller_ip+":"+service_port+"/v2.0/routers/"+router_id+"/add_extraroutes"
